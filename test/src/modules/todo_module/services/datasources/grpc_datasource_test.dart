...
class FakeTaskServiceClient extends Mock implements TaskServiceClient {
  @override
  ResponseFuture<TaskFetchWithMetaDataMessage> getTasks(
    GetTasksParams request, {
    CallOptions? options,
  }) {
    return FakeResponseFuture<TaskFetchWithMetaDataMessage>(
...
void main() {
  ...
  group('Get method', () {
    test('Should have get method - Success case', () async {
      ...
      final TaskFetchWithMetaDataMessage expectValueTaskServiceClient =
          await mockTaskServiceClient.getTasks(GetTasksParams());
